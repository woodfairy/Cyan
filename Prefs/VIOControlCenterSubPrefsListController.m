#import "VIOControlCenterSubPrefsListController.h"
...
@implementation VIOControlCenterSubPrefsListController
...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.enableSwitch.onTintColor = [UIColor colorWithRed:0.76 green:0.92 blue:0.89 alpha:1.00];
